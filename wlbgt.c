        ...
        while(state==0){
                ...
                switch (state) {
                        ...
                        case 5:
                                printf("\e[1;1H\e[2J");
                                printf("/-------------------------------------------------------\\\n");
                                printf("\nHello, and welcome to WLSGT (Whitlock Lab Scaffold GCode Tool). This software was developed by CJ Replogle (a student-researcher) at Cincinnati Children's as a method of generating gcode files for the Whitlock lab for use in bioprinting. ");
